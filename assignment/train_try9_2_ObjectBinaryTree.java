...
class ObjectStack4 {
	...
	public void dump() {
		for(int i = 0;i < top;i++) {
			 System.out.println(data.get(i).data.toString());
		}
	}
}
...
class ObjectQueue4 {
	...
	public void dump() {
		...
		for(int i = front + 1; i <= rear; i++) {
			System.out.println(que[i].data.toString());
		}
	}
}
